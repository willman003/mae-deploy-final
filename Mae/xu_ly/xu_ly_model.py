...
class San_pham(db.Model):
    ...
    ma_loai = db.Column(db.Integer, ForeignKey('loai_san_pham.ma_loai'))
...
class Nguoi_dung(db.Model):
    ...
    ho_ten = db.Column(String(200))
    ten_dang_nhap = db.Column(String(64), nullable = False)
    mat_khau_hash = db.Column(String(128), nullable = False)
